 ...
 * @package Tube
 */
class CTube implements ISingleton 
{
	...
	protected function __construct() {
		...
		$tube = &$this;
    require(TUBE_SITE_PATH.'/config.php');
  ...
  public function ThemeEngineRender() {
    ...
    $themePath 	= TUBE_INSTALL_PATH . "/themes/{$themeName}";
    ...
    $tube = &$this;
    include(TUBE_INSTALL_PATH . '/themes/functions.php');
